  ...
  return (
    <div className="relative">
      <select
        ...
        disabled={disabled}
        className="appearance-none px-4 py-2 pr-10 rounded-lg bg-white/10 dark:bg-black/10 backdrop-blur-md border border-white/20 dark:border-black/20 text-gray-900 dark:text-white font-medium hover:bg-white/20 dark:hover:bg-black/20 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        {MODELS.map((model) => (
